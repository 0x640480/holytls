...
// Resolve a (possibly relative) reference (e.g. a Location header) against a
// base URL into an absolute URL, arena-allocated. Handles absolute,
// protocol-relative
// (//host), absolute-path (/path), and simple relative refs (no ../
// normalization).
